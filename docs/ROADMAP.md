...
Phase 2  M2                           first end-to-end slice (deploy deferred per D8 in CONTEXT.md)
         Ops catalog research starts and never stops (Spain-first per D4)
...
- Deployment is deferred by decision ([D8](CONTEXT.md#founder-decisions-log)): M9 starts before the beta gate; we accept that ops surprises arrive later in exchange for zero hosting cost/ops now.
