...
|---|---|---|---|---|
| Listing visible in catalog | ✅ | ✅ | ✅ | ✅ |
| Asking price shown | ✅ | ✅ (informational) | ✅ (informational) | ✅ (informational) |
| Chat between buyer & seller | ✅ | ✅ | ✅ after acknowledgment | ✅ after acknowledgment |
| **Buy button / payment through platform** | ✅ | ❌ | ❌ | ❌ |
| Link-out to official transfer procedure | n/a | ✅ prominent | n/a | n/a |
...
| Buyer acknowledgment recorded (`policy_acks`) | — | — | ✅ before first message | ✅ before first message |
