...
export const es: Record<MessageKey, string> = {
	...
	'nav.inbox': 'Mensajes',
	'nav.inboxUnread.one': '{n} mensaje sin leer',
	'nav.inboxUnread.other': '{n} mensajes sin leer',
	...
	'races.filter.distance': 'Distancia',
	'races.filter.dateFrom': 'Desde',
	'races.filter.dateTo': 'Hasta',
	'races.filtersSummary': 'Filtros',
	'races.resultCount.one': '{n} carrera',
	'races.resultCount.other': '{n} carreras',
	'races.resultCountMore': 'Mostrando las primeras {n} carreras',
	'races.removeFilter': 'Quitar filtro: {name}',
	...
	'myListings.view': 'Ver',
	'myListings.cancelConfirm': '¿Cancelar este anuncio? Los compradores dejarán de verlo.',
	'myListings.cancelled': 'Anuncio cancelado.',
	'myListings.created': 'Tu anuncio ya está publicado.',

	'listingStatus.active': 'Activo',
	'listingStatus.reserved': 'Reservado',
	'listingStatus.sold': 'Vendido',
	'listingStatus.cancelled': 'Cancelado',
	'listingStatus.expired': 'Caducado',
	'listingStatus.removed': 'Retirado',
